...
puts ascii_translator(65)  # Output: "A"
puts common_sports(["soccer", "basketball"], ["basketball", "tennis"])
puts alphabetical_list(["soccer", "basketball", "tennis", "soccer"])
puts lucky_number
puts ascii_code("A")  # Output: 65
puts ascii_code("AB") # Output: "Input Error"
pet_pun("cat")
pet_pun("dog")
pet_pun("hamster")