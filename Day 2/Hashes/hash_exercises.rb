...
puts create_favorite_hash("blue", 7)
puts favorite_color({ color: "green", number: 3 })
puts favorite_number({ color: "green" })
puts update_favorite_movie({ color: "green", number: 3 }, "Inception")
puts remove_favorite_number({ color: "green", number: 3 })
puts favorite_categories({ color: "green", number: 3, movie: "Inception" })
puts favorite_items({ color: "green", number: 3, movie: "Inception" })
puts merge_favorites({ color: "green" }, { number: 3, movie: "Inception" })